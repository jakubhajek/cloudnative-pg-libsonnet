{
  ...
  spec: {
    ...
    backup: {
      ...
      '#withTarget':: d.fn(help='"The policy to decide which instance should perform backups. Available options are empty string, which will default to `primary` policy, `primary` to have backups run always on primary instances, `prefer-standby` to have backups run preferably on the most updated standby, if available."', args=[d.arg(name='target', type=d.T.string)]),
    ...
    bootstrap: {
      ...
      recovery: {
        '#backup':: d.obj(help='"The backup we need to restore"'),
        backup: {
          '#endpointCA':: d.obj(help='"EndpointCA store the CA bundle of the barman endpoint. Useful when using self-signed certificates to avoid errors with certificate issuer and barman-cloud-wal-archive."'),
          endpointCA: {
            '#withKey':: d.fn(help='"The key to select"', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withSource':: d.fn(help='"The external cluster whose backup we will restore. This is also used as the name of the folder under which the backup is stored, so it must be set to the name of the source cluster"', args=[d.arg(name='source', type=d.T.string)]),
    ...
    '#withPrimaryUpdateMethod':: d.fn(help='"Method to follow to upgrade the primary server during a rolling update procedure, after all replicas have been successfully updated: it can be with a switchover (`switchover` - default) or in-place (`restart`)"', args=[d.arg(name='primaryUpdateMethod', type=d.T.string)]),
    withPrimaryUpdateMethod(primaryUpdateMethod): { spec+: { primaryUpdateMethod: primaryUpdateMethod } },
    '#withPrimaryUpdateStrategy':: d.fn(help='"Strategy to follow to upgrade the primary server during a rolling update procedure, after all replicas have been successfully updated: it can be automated (`unsupervised` - default) or manual (`supervised`)"', args=[d.arg(name='primaryUpdateStrategy', type=d.T.string)]),
