{
  ...
  '#spec':: d.obj(help='"PoolerSpec defines the desired state of Pooler"'),
  spec: {
    ...
    pgbouncer: {
      ...
      '#withPoolMode':: d.fn(help='"The pool mode"', args=[d.arg(name='poolMode', type=d.T.string)]),
    ...
    '#withInstances':: d.fn(help='"The number of replicas we want"', args=[d.arg(name='instances', type=d.T.integer)]),
    withInstances(instances): { spec+: { instances: instances } },
    '#withType':: d.fn(help='"Which instances we must forward traffic to?"', args=[d.arg(name='type', type=d.T.string)]),
